...
function configQuestions(main, chalk, inquirer) {
  ...
  `));
        ...
        main(localRepo ? localRepoPath : repoUrl, localRepo, features.includes("Add line numbers"), features.includes("Add highlighting"), features.includes("Add page numbers"), features.includes("Remove comments"), features.includes("Remove empty lines"), features.includes("One PDF per file"), outputFileName, outputFolderName, keepRepo);
    });
}
