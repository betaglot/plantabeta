...
let elementName = "Morfos"

</script>

# 🔻<span class="via">Morfos</span>
...
- Alias:
    - It's not called "Form" since "Form" can mean technique, posture, and shape is only two dimensional

    - Form
    - Shape
- Differentiate(Morfos,Space)
- Passag.Morfos
- [Hole.Morfos]
- Etymology
    - Morphology
