...
::: details Why is it called <span class="ekos">EKOS</span>?

## Etymology of "<span class="ekos">Ekos</span>" and "<span class="ekos">EKON</span>"

The name of the EKOS is derived from <span class="ekos">eco</span>system
...
The word "<span class="ekos">EKOS</span>system" was derived from <span class="ekos">eco</span>logy

> (originally as <span class="ekos">oeco</span>logy ): from Greek <span class="ekos">oikos</span> ‘house’ + -logy.

:::

---

::: details Examples of <span class="ekos">EKOS</span> in everyday life
