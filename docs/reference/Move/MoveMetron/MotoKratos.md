# 🔷🟠 <move>MotoIntensity</move>

## Definition

### Relationship between <move>MotoIntensity</move> and <via>RouteIntensity</via>
...
### Relationship between <psike>MotoIntensity</psike> and <psike>NeuroIntensity</psike>
